...
***************************/
        ...
        html
        {
            background: #e6e6e6 url('http://phpbbex.com/oldies/images/bkg-html.jpg') repeat-x;
            height: 100%;
            /*width: 100%;*/
        }
        ...
        ***************************/
        ...
        body
        {
            background: transparent url('http://phpbbex.com/oldies/images/bkg-body.jpg') no-repeat right top;
            height: 100%;
            /*width: 100%;*/
        ...
        #modern-browser li.ie8{background:url('http://phpbbex.com/oldies/images/big-ie8.gif') no-repeat 5px top;}
        #modern-browser li.chrome{background:url('http://phpbbex.com/oldies/images/big-chrome.gif') no-repeat 15px top;}
        #modern-browser li.opera{background:url('http://phpbbex.com/oldies/images/big-opera.gif') no-repeat left top;}
        #modern-browser li.firefox{background:url('http://phpbbex.com/oldies/images/big-firefox.gif') no-repeat 10px top;}
        ...
        #modern-browser .file li.microsoft{background:url('http://phpbbex.com/oldies/images/fav-ie.gif') no-repeat left;}
        #modern-browser .chrome .file li{background:url('http://phpbbex.com/oldies/images/fav-chrome.gif') no-repeat left;}
        #modern-browser .opera .file li{background:url('http://phpbbex.com/oldies/images/fav-opera.gif') no-repeat left;}
        #modern-browser .firefox .file li{background:url('http://phpbbex.com/oldies/images/fav-firefox.gif') no-repeat left;}
...
<div id="old">
    ...
    <ul id="modern-browser">
        ...
        <li class="ie8">
            ...
            <div class="descriptiontext">
                <span>Современная версия браузера от компании Microsoft. Бесплатно предоставляется всем желающим и свободен для распространения. Если слова «браузер» и «Internet Explorer» для вас незнакомы, установите эту программу.</span>
                <ul class="file">
